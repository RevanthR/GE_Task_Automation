...
with open(dir_name + ' Job_Function_Stats.csv','w',newline='') as file:
    ...
    writer.writerow(['Report Name','Job Function','Query Count(Year)','Query Count(Q1)','Query Count(Q2)','Query Count(Q3)','Query Count(Q4)',"Jan_Query","Feb_Query","Mar_Query","Apr_Query","May_Query","Jun_Query","July_Query","Aug_Query","Sep_Query","Oct_Query","Nov_Query","Dec_Query"])
