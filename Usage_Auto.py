...
for filename in os.listdir(dir_name):
    dst= dir_name + "/" + new_name +"_Reports_new_"+str(i)+".csv"
...
with open(new_name + '_Report_Summary.csv','w',newline='') as file:
    ...
    writer.writerow(["Dashboard Name","Analysis Name","User Count","Query Count","User Count(Jan 2019)","Query Count(Jan 2019)","Job Function"])
...
for file in files:
    ...
    # Count the number of users in the month of Jan
